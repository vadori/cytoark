...
- [**Histo-Smith**](https://arxiv.org/abs/2502.08754), a novel single-stage approach for generating image-label pairs to augment annotated histology datasets for cell instance segmentation and classificaton 
...
## Acknowledgments
We thank all the authors who inspired us and shared their work. In particular:
